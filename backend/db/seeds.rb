...
Employee.create(first_name: 'João', last_name: 'Silva', birth_date: '01/01/1980', start_date: '10/12/2012',
...
Employee.create(first_name: 'Luís', last_name: 'Ferreira', birth_date: '05/10/1977', start_date: '05/06/2018',
...
Employee.create(first_name: 'Henrique', last_name: 'Dias', birth_date: '07/10/1999', start_date: '16/03/2022',
...
Employee.create(first_name: 'Maria', last_name: 'Silveira', birth_date: '05/12/2000', start_date: '16/03/2022',
...
Employee.create(first_name: 'Julia', last_name: 'Dos Passos', birth_date: '05/12/1971', start_date: '10/11/2010',
...
Employee.create(first_name: 'Carlos', last_name: 'Dos Anjos', birth_date: '06/03/1985', start_date: '03/11/2019',
...
Employee.create(first_name: 'Marcio', last_name: 'Silva', birth_date: '01/01/1977', start_date: '10/12/2012',
...
Employee.create(first_name: 'João', last_name: 'Mateus', birth_date: '01/01/1980', start_date: '10/12/2012',
...
Employee.create(first_name: 'Isadora', last_name: 'Maria', birth_date: '12/12/1965', start_date: '10/12/2012',
...
Employee.create(first_name: 'Pedro', last_name: 'Da Silva', birth_date: '12/12/1965', start_date: '10/12/2012',
...
Employee.create(first_name: 'Julio', last_name: 'Dos Passos', birth_date: '12/12/1965', start_date: '10/12/2012',
...
Employee.create(first_name: 'Luis', last_name: 'Do Teste', birth_date: '12/12/1965', start_date: '10/12/2012',
...
Employee.create(first_name: 'Gabriel', last_name: 'Miguel', birth_date: '12/12/1965', start_date: '10/12/2012',
